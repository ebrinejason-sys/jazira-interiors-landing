...
const floatingFurniture = [
  {
    ...
    className: "right-[4%] top-[24%] w-48 md:w-72",
    rotate: -4,
    speed: [0, -70],
  },
  {
    ...
    className: "right-[20%] bottom-[10%] w-36 md:w-56",
    rotate: 5,
    speed: [0, 80],
  },
  {
    ...
    className: "left-[6%] bottom-[6%] hidden w-52 md:block lg:w-72",
    rotate: 3,
    speed: [0, 52],
  },
];
...
export default function HeroSection() {
  ...
  return (
    <section id="top" ref={ref} className="relative min-h-[92vh] overflow-hidden bg-midnight pt-20 text-white">
      <motion.img
        style={{ y: imageY }}
        ...
        className="absolute inset-0 h-[112%] w-full object-cover opacity-62"
      />
      ...
      <div className="section-shell relative z-10 flex min-h-[calc(92vh-5rem)] items-center py-16">
        <motion.div style={{ y: textY }} className="max-w-3xl">
          ...
          <motion.h1
            ...
            className="mt-5 font-display text-6xl font-semibold leading-[0.92] tracking-normal md:text-8xl lg:text-9xl"
          >
            Jazira Interiors
          </motion.h1>
          <motion.p
            ...
            className="mt-6 max-w-2xl text-2xl font-semibold leading-tight text-white md:text-4xl"
          >
          ...
          <motion.p
            ...
            className="mt-5 max-w-2xl text-base leading-8 text-white/78 md:text-lg"
          >
          ...
          >
            {["Bespoke furniture", "Quote-ready leads", "Future payments"].map((item) => (
